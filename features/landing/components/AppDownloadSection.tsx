...
export function AppDownloadSection() {
    return (
        <section id="download" className="py-20 px-6 bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-100 relative overflow-hidden">
            {/* Decorative Grid */}
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        >
                            Download our app to join queues from anywhere and save time.                       </motion.p>
